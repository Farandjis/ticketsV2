...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['fermer_ticket'])) {
        ...
        if (!empty($_POST['id_ticket'])) {
            ...
            // On ferme le ticket. Si c'est possible, renvoi 1, sinon 0. On converti en booléan True/False
            ...
            if ($resultatFermeture) {
                ...
                echo "<script>document.getElementById('retourPageModifTicket').submit();</script>"; // On envoi automatiquement le formulaire
            }
            return;
        }
        ...
        if (!empty($_POST["explication2"]) && !empty($_POST['nivUrg']) && !empty($_POST['titre'])) {
