...
// V�rifie l'acc�s � la page en fonction des r�les
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST['fermer_ticket'])) {
            if (!empty($_POST['id_ticket'])) {
                ...
                // On ferme le ticket. Si c'est possible, renvoi 1, sinon 0. On convertit en bool�en True/False
                ...
                if ($resultatFermeture) {
                    // Succ�s, on redirige vers le tableau de bord
                    header('Location: tableaudebord.php');
                    return;
                } else {
                    // Echec, on pr�pare la redirection vers la page modifTicket
            ...
            if (in_array($niveauUrgence, $niveauUrgenceAutorise)) {
                ...
                if ($existingTitre) {
                    ...
                    // Modifier le ticket en fonction des r�les et de l'�tat du ticket
                    ...
                    if (recupererRoleDe($connexionUtilisateur) == 'Technicien' || recupererRoleDe($connexionUtilisateur) == 'Administrateur Site') {
                        ...
                        // Supprimer les relations mots-cl�s existantes
                        ...
                        // Ajouter de nouvelles relations mots-cl�s
                        foreach ($_POST["motcle_option"] as $unMotcleTicket) {
                            ...
                            // On s'assure que le mot-cl� � ajouter existe bien
                    ...
                    // Rediriger vers le tableau de bord apr�s la modification
                    header('Location: tableaudebord.php');
                    return;
                } else {
                    $_SESSION['titre'] = $_POST['titre'];
