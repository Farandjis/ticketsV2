...
<div class="conteneur_administration_general conteneur_administration">
    <div class="conteneur_ajout_administration">
      ...
      if(isset($_GET['id'])) {
            ...
            echo '<p>';
            if ($_GET['id'] == 10){ echo "ERREUR : Une erreur est survenue"; }
            echo '</p>';
            echo '</div>';
        }


          echo '<label for="ajout_technicien">Ajout de Technicien :</label><br>
		    ...
		    echo '<div class="conteneur_ajout_administration">
                          <form action="action_ajouttitre.php" method="post" name="Ajout Titre" class="ajout" onsubmit="return confirmerAvantEnvoi(this.name)">';
                            ...
                            if(isset($_GET['id'])) {
                                echo '<div class="erreur">';
                                echo '<p>';
                                if ($_GET['id'] == 301) { echo "ERREUR : Catégorie inexistante "; }
                                else if ($_GET['id'] == 302) { echo "ERREUR : Texte trop court"; }
                                else if ($_GET['id'] == 303) { echo "ERREUR : La combinaison du texte et de la catégorie est trop longue "; }
                                else if ($_GET['id'] == 304) { echo "ERREUR : Le titre est déjà existant"; }
                                else if ($_GET['id'] == 305) { echo "ERREUR : Option manquante"; }
                                else if ($_GET['id'] == 300){ echo "ERREUR : Une erreur est survenue"; }
                                echo '</p>';
                                echo '</div>';
                            }


                              echo '<label for="ajout_titre">Ajout de Titre :</label><br>
                              ...
                              <input id="ajout_titre" type="text" name ="ajout_titre" placeholder="Écrire un titre" minlength="11">
      ...
      <form action="action_ajoutmotcle.php" method="post" name="Ajout Libelle" class="ajout" onsubmit="return confirmerAvantEnvoi(this.name)">';
        ...
        if(isset($_GET['id'])) {
            echo '<div class="erreur">';
            echo '<p>';
            if ($_GET['id'] == 201) { echo "ERREUR : Catégorie inexistante "; }
            else if ($_GET['id'] == 202) { echo "ERREUR : Texte trop court"; }
            else if ($_GET['id'] == 203) { echo "ERREUR : La combinaison du texte et de la catégorie est trop longue "; }
            else if ($_GET['id'] == 204) { echo "ERREUR : Le titre est déjà existant"; }
            else if ($_GET['id'] == 205) { echo "ERREUR : Option manquante"; }
            else if ($_GET['id'] == 200){ echo "ERREUR : Une erreur est survenue"; }
            echo '</p>';
            echo '</div>';
        }

        echo '<label for="ajout_motcle">Ajout de Mots-clés :</label><br>
        <div class="conteneur_categorie">
        <select name="categorieMc" id="categorieMc" class="creer_select" required>';
        ...
        <input id="ajout_motcle" type="text" name ="ajout_motcle" placeholder="Écrire un mot-clé" minlength="3">
            ...
            <form action="action_bandeban.php" method="post" name="Bannir Compte" onsubmit="return confirmerAvantEnvoi(this.name)">
                <h1>Comptes TIX</h1>
                    ...
                    if (isset($_GET["id"])) {
						...
						echo "<p style='color:white;'>Aucune information à afficher.</p>"; 
					}
                   echo '</div><br>
  ...
  ";
	...
	if (recupererRoleDe($connection) == 'Administrateur Système'){
		echo ' 
		  ...
		  echo ' 
		  <h1 class="titre_page"  id="activite">
			Journal d\'activité
		  </h1>
		  <div class="activite" >
...
<div class="activite">
    <div class="inscription-utilisateur">
        <h2>Inscription</h2>
        <div class="conteneur_table conteneur_table-inscription-desinscription">
            <table class="table-inscription-desincription table-popup">
                <thead>
                <tr>
                    <th>Archive</th>
                    <th>Suppression</th>
                ...
                <tbody>';
        dirToTable("../../../logs/archives/","ActvInsc");
        echo '
                </tr>
                </tbody>
            </table>
    ...
    <div class="desinscription-utilisateur">
        ...
        <div class="conteneur_table conteneur_table-inscription-desinscription">
            <table class="table-inscription-desincription table-popup">
                ...
                <tbody>';
        dirToTable("../../../logs/archives/","ActvDesinsc");
        echo '
                </tbody>
            </table>
        </div>
