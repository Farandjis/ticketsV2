...
INSERT INTO Ticket(id_user, objet_ticket, description_ticket, niv_urgence_estimer_ticket, NIV_URGENCE_DEFINITIF_TICKET, ETAT_TICKET) VALUES
	(1, "Problème d'imprimante", "Le document ne s'imprime pas correctement, besoin d'aide.", "Urgent", "Non complété !", "en_attente"),
	...
	(3, "Besoin d'une nouvelle clé d'accès", "La clé actuelle ne fonctionne plus, nécessite une mise à jour.", "Moyen", "Non complété !", "en_cours_de_traitement"),
	(1, "Écran noir", "L'écran de l'ordinateur est complètement noir, aucune activité visible.", "Urgent", "Urgent", "en_attente"),
	...
	(3, "Impossible d'ouvrir des fichiers", "Rencontre des difficultés pour ouvrir certains fichiers, demande d'assistance.", "Moyen", "Moyen", "en_cours_de_traitement"),
	(4, "Lenteur du système", "L'ordinateur fonctionne lentement, nécessite une optimisation.", "Faible", "Faible", "ferme"),
	(1, "Problème d'accès au compte", "Impossible de se connecter au compte, demande de réinitialisation du mot de passe.", "Urgent", "Urgent", "en_attente"),
	...
	(3, "Erreur système", "Reçoit des messages d'erreur système fréquents, nécessite une résolution.", "Moyen", "Moyen", "en_cours_de_traitement"),
	(4, "Problème de son", "Aucun son ne sort des haut-parleurs, vérification nécessaire.", "Faible", "Faible", "ferme"),
	(1, "Problème de sécurité", "Soupçonne une activité de piratage, demande une vérification de sécurité.", "Urgent", "Urgent", "en_attente"),
	...
	(3, "Besoin de droits d'accès", "L'utilisateur ne peut pas accéder à certaines fonctionnalités, nécessite des droits d'accès supplémentaires.", "Moyen", "Moyen", "en_cours_de_traitement"),
	(4, "Problème d'alimentation", "L'ordinateur ne s'allume pas, vérification de l'alimentation nécessaire.", "Faible", "Faible", "ferme");
