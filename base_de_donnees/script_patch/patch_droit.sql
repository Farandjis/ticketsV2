...
TO 'role_technicien';
GRANT UPDATE(OBJET_TICKET, ID_TECHNICIEN, DESCRIPTION_TICKET, ETAT_TICKET, NIV_URGENCE_DEFINITIF_TICKET, HORODATAGE_DERNIERE_MODIF_TICKET, HORODATAGE_RESOLUTION_TICKET)
ON vue_modif_ticket_adm_tech
TO 'role_admin_web';
