...
CREATE TABLE Utilisateur (
    ...
    HORODATAGE_OUVERTURE_USER DATETIME DEFAULT CURRENT_TIMESTAMP,
    HORODATAGE_DERNIERE_CONNECTION_USER DATETIME DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE Ticket (
    ...
    NIV_URGENCE_ESTIMER_TICKET VARCHAR(15) DEFAULT 'Non complété !',
    NIV_URGENCE_DEFINITIF_TICKET VARCHAR(15) DEFAULT 'Non complété !',
    ETAT_TICKET VARCHAR(30) DEFAULT 'En attente',
    HORODATAGE_CREATION_TICKET DATETIME DEFAULT CURRENT_TIMESTAMP,
