...
| 3      | $login = "aliceeeeeeeeeeeeeeeeeeeeeeeeeeeee" <br> $mdp = "Azertyyy!123" <br> $mdp2 = "Azertyyy!123" <br> $prenom = "Alice" <br> $nom = "AVRIL" <br> $email = alice.avril@email.com | KO               | KO               | Login trop long (> 32)                                                                                                                |
| 4      | $login = "aliceeeeeeeeeeeeeee" <br> $mdp = "Azertyyy!123" <br> $mdp2 = "Azertyyy!123" <br> $prenom = "Alice" <br> $nom = "AVRIL" <br> $email = alice.avril@email.com  | OK               | OK               | Login compris entre 5 (compris) et 32 (compris)                                                                                       |
